  ...
  return (
    <div className="Hero_container">
      <div className="container">
        ...
        <p className="text2">
          More than a platform, we're a community making education accessible
          for all.
        </p>
      </div>
      ...
      <div className="body">
        ...
        <p>
          We are a community driven crowdfunding platform committed to making
          education accessible to every student, regardless of their financial
        </p>
        <p>
          background. We connect students who need support to sponsors and
          oragnization willing to help fund their academic dreams.Through
        </p>
        <p>
          transparency, trust, and inovation, we're building a bridge between
      ...
      <section className="mission_card">
        <div className="session_card">
          <div className="card1">
            <h3>OUR MISSION</h3>
            <p>
              At EduFund, our mission is to make education accessible for every
              student by creating a transparent, secure, and direct way to fund
              tuition and educational needs.
            </p>
          </div>
          <div className="card1">
            <h3>OUR VISION</h3>
            <p>
              We envision a future where no student drops out because of
              financial barriers - where opportunity is based on potential, not
              income.
            </p>
          </div>
          <div className="card1">
            ...
            <p>
              Transparency - Every donation is verified and goes directly to
              schools to build trust
              <br />
              Enpowerment - We help students pursue education despite financial
              barriers.
            </p>
          </div>
        </div>
      ...
      <section className="edu-section">
        ...
        <div className="edu-content">
          <h2>
            EduFund <span>The Ultimate Platform for Educational Support</span>
          </h2>
          <p>
            ...
            sponsors who believe in the power of education. Through a
